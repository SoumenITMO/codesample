...
@IdClass(GuestAccountDefaultsId.class)
public class GuestAccountDefaults {
    ...
    @Basic
    @Column(name = "default_credit_limit", nullable = false, precision = 4, insertable=false)
    ...
    public boolean equals(Object o) {
        ...
        GuestAccountDefaults that = (GuestAccountDefaults) o;
